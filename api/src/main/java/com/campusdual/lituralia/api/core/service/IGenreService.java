...
public interface IGenreService {
    ...
    EntityResult vGenreBookDetailsQuery(Map<String, Object> keysValues, List<String> attributes)        throws OntimizeJEERuntimeException;
    EntityResult vGenreBookDetailsDelete(Map<String, Object> keyValues) throws OntimizeJEERuntimeException;
}
